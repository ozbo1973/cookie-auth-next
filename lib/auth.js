...
export const authIntialProps = isProtectedRoute => ({ req, res }) => {
...
export const getServerSideToken = ({ signedCookies = {} }) => {
  const user = signedCookies && signedCookies.token ? signedCookies.token : {};
